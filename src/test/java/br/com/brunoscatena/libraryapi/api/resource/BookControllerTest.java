...
public class BookControllerTest {
    ...
    public void createBookWithDuplicatedIsbn() throws Exception {
        ...
        BDDMockito.given(service.save(any(Book.class))).willThrow(new BusinessException(errorMessage));
    ...
    public void getBookByIdTest() throws Exception {
        ...
        // given
        Long id = 1L;
        Book book = Book.builder().id(id).title("Adventures").author("Some One").isbn("1234").build();
    ...
    public void updateBookTest() throws Exception {
        ...
        mvc.perform(request)
                ...
                .andExpect( MockMvcResultMatchers.jsonPath("author").value( newBookValues.getAuthor() ) )
    ...
    public void findBookTest() throws Exception {
        ...
        Book book = Book.builder().id(1L).author("Bruno").title("As aventuras").isbn("1234").build();
